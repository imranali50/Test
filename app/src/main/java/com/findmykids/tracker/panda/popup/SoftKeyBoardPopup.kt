...
import com.findmykids.tracker.panda.adapter.GridMenuAdapter
import com.findmykids.tracker.panda.adapter.MenuRecyclerView
import com.findmykids.tracker.panda.util.toPx
...
class SoftKeyBoardPopup(
    ...
    private fun showAtTop() {
        ...
        showAtLocation(
            ...
            Gravity.TOP,
            0,
            (rootView.top - keyboardHeight) + (rootView.height - 30.toPx())
        )
    }
    ...
    private fun showOverKeyboard() {
        ...
        setSize(LayoutParams.MATCH_PARENT, keyboardHeight + 30.toPx())
        showAtLocation(rootView, Gravity.BOTTOM, 0, (anchorView.bottom))
    }
    ...
    override fun onCameraClick(name: String) {
        onclick.invoke(name)
    }
}