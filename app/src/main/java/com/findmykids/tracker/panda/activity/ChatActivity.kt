...
class ChatActivity : BaseActivity(), View.OnClickListener, MenuEditText.PopupListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Glide.with(this@ChatActivity).load(intent.getStringExtra(ChatGroupIcon).toString())
    ...
    private fun setAllClickListener() {
        ...
        b.ivSend.setOnClickListener {
            ...
            if (send_click_response && b.edtChat.text?.trim().toString().isNotEmpty() && utils.isNetworkAvailable()) {
        ...
        menuKeyboard = SoftKeyBoardPopup(
            ...
            when (it) {
                "Gallery" -> {
                    ...
                    if (hasPermissions(this@ChatActivity, GALLERY_PERMISSION)) {
...
//                }
                ...
                "Camera" -> {
                    menuKeyboard.dismiss()
                    if (hasPermissions(this@ChatActivity, CAMERA_PERMISSION)) {
...
//                            }
    ...
    private var settingCameraLauncher =
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            if (checkSelfPermissions(this@ChatActivity, CAMERA_PERMISSION)) {
                openCameraLauncherIntent()
            }
        }
    ...
    private var settingGalleryLauncher =
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            if (checkSelfPermissions(this@ChatActivity, GALLERY_PERMISSION)) {
                openGalleryLauncherIntent()
            }
        }
    ...
    private val permCameraLauncher =
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            ...
            if (granted) {
                ...
                if (shouldShow(this@ChatActivity, CAMERA_PERMISSION)) {
    ...
    private val permGalleryLauncher =
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            ...
            if (granted) {
                ...
                if (shouldShow(this@ChatActivity, GALLERY_PERMISSION)) {
